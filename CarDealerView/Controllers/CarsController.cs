...
namespace CarDealerView.Controllers
{
    ...
    public class CarsController : Controller
    {
        ...
        {
            ViewData["CarModelId"] = new SelectList(_context.CarModels, "CarModelId", "Manufacturer");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CarId,ProductionYear,Mileage,AccidentFree,Price,Discount,CarModelId")] Car car)
        {
            if (id != car.CarId)
            {
                return NotFound();
